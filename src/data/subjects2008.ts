...
export const subjects2008: SubjectConfig[] = [
  ...
  },
  {
    ...
    units: [
      {
        id: "2008_fin_u1",
        title: "الوحدة الأولى: الأسواق المالية",
        lessons: [
          { id: "2008_fin_u1_l1", title: "مفهوم الأسواق المالية" },
          { id: "2008_fin_u1_l2", title: "الأسهم والسندات" },
        ]
      },
      {
        id: "2008_fin_u2",
        title: "الوحدة الثانية: البنوك والمؤسسات",
        lessons: [
          { id: "2008_fin_u2_l1", title: "المؤسسات المصرفية" },
          { id: "2008_fin_u2_l2", title: "الاستثمارات الشخصية" },
        ]
      }
    ]
  }
